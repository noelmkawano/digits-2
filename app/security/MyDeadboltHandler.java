...
/**
 * Handles the Deadbolt functionality of only granting specific users access TO pages.
 */
public class MyDeadboltHandler extends AbstractDeadboltHandler {

  /**
   * Checks if the user has access to the given resource.
   * @param context The page the user is trying to access.
   * @return The page if access granted, the login page otherwise.
   */
  @Override
