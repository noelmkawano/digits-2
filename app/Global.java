...
public class Global extends GlobalSettings {
  ...
  public void onStart(Application application) {
    ...
    if (Contact.find().all().isEmpty()) {
      ...
      testDiet.add(0, "Beef");
      ContactDB.addContact(new ContactFormData("Patrick", "Karjala", "808-222-3333", "Mobile", testDiet));
      List<String> testDiet2 = new ArrayList<>();
      testDiet2.add(0, "Chicken");
      testDiet2.add(1, "Gluten");
      ContactDB.addContact(new ContactFormData("Brooke", "Jones", "808-111-2222", "Mobile", testDiet2));
      List<String> testDiet3 = new ArrayList<>();
      ContactDB.addContact(new ContactFormData("Bradford", "Jones", "254-879-0744", "Home", testDiet3));
      List<String> testDiet4 = new ArrayList<>();
      testDiet4.add(0, "Dairy");
      testDiet4.add(1, "Beef");
      testDiet4.add(2, "Fish");
      ContactDB.addContact(new ContactFormData("Bud", "Jones", "808-123-4567", "Work", testDiet4));
    }
  }
}
